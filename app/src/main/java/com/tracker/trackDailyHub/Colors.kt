...
val popularColors = listOf(
    ...
    Color(0xFF48D1CC), // MediumTurquoise
    ...
    Color(0xFF00CED1)  // DarkTurquoise (дубликат для полного списка)
)

val popularColors1 = listOf(
    Color.Red, Color.Green, Color.Blue,
    Color.Yellow, Color.Magenta, Color.Cyan,
)

val popularColors2 = listOf(
    Color.Gray, Color.Black, Color.White,
    Color(0xFFFFD700), // Gold
    Color(0xFF8A2BE2), // BlueViolet
    Color(0xFFA52A2A),
